const {
    ...
    SELECTOR_MOBILE_CREATE_ANNOTATION_DIALOG,
...
Feature('Mobile Point Annotation Sanity');

Before((I) => {
    I.amOnPage('/');
});

Scenario('Create a new point annotation @mobile', (I) => {
    ...
    I.click(SELECTOR_BOX_PREVIEW);

    I.say('Pending annotation should be visible');
    I.waitForVisible(SELECTOR_MOBILE_CREATE_ANNOTATION_DIALOG);
    I.waitForEnabled(SELECTOR_CREATE_COMMENT);
    ...
    I.waitForVisible(SELECTOR_MOBILE_ANNOTATION_DIALOG);
    I.seeNumberOfElements(SELECTOR_ANNOTATION_COMMENT, 1);

    I.say('Close the annotation dialog');
    I.click(SELECTOR_DIALOG_CLOSE);
...
// Scenario('Reply to an existing point annotation @mobile', (I) => {
...
// Scenario('Delete reply to a point annotation @mobile', (I) => {
//     I.say('An annotation should be visible');
//     I.waitForVisible(SELECTOR_ANNOTATIONS_LOADED);
//     I.seeNumberOfElements(SELECTOR_ANNOTATION_POINT_MARKER, 1);
...
// Scenario('Delete the point annotation thread @mobile', (I) => {
//     I.say('An annotation should be visible');
//     I.waitForVisible(SELECTOR_ANNOTATIONS_LOADED);
//     I.seeNumberOfElements(SELECTOR_ANNOTATION_POINT_MARKER, 1);
//     I.scrollTo(SELECTOR_ANNOTATION_POINT_MARKER);
