...
// Scenario('Create a new point annotation @desktop', (I) => {
...
// Scenario('Reply to an existing point annotation @desktop', (I) => {
...
// Scenario('Delete reply to a point annotation @desktop', (I) => {
//     I.say('An annotation should be visible');
//     I.waitForVisible(SELECTOR_ANNOTATIONS_LOADED);
//     I.seeNumberOfElements(SELECTOR_ANNOTATION_POINT_MARKER, 1);
...
// Scenario('Delete the point annotation thread @desktop', (I) => {
//     I.say('An annotation should be visible');
//     I.waitForVisible(SELECTOR_ANNOTATIONS_LOADED);
//     I.seeNumberOfElements(SELECTOR_ANNOTATION_POINT_MARKER, 1);
//     I.scrollTo(SELECTOR_ANNOTATION_POINT_MARKER);
