...
class ImageDrawingDialog extends AnnotationDialog {
     ...
     * @return {ImageDrawingDialog} Drawing dialog instance
     */
    constructor(data) {
        super(data);
    ...
    destroy() {
        ...
        if (this.annotatedElement && this.annotatedElement.contains(this.element)) {
            this.annotatedElement.removeChild(this.element);
        }
    ...
    position(x, y) {
        ...
        if (!this.annotatedElement.contains(this.element)) {
...
export default ImageDrawingDialog;
