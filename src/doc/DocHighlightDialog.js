...
class DocHighlightDialog extends AnnotationDialog {
    ...
    addAnnotation(annotation) {
        ...
        if (annotation.text === '' && annotation.user.id !== '0') {
            const highlightLabelEl = this.highlightDialogEl.querySelector(
                `.${constants.constants.CLASS_HIGHLIGHT_LABEL}`
            );
    ...
    generateHighlightDialogEl(canDeleteAnnotation, showComment) {
        ...
        highlightLabelEl.classList.add(constants.constants.CLASS_HIGHLIGHT_LABEL);
