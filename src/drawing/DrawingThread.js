...
class DrawingThread extends AnnotationThread {
    ...
    bindDrawingListeners(locationFunction) {
        this.annotatedElement.addEventListener('mousemove', eventToLocationHandler(locationFunction, this.handleMove));
        this.annotatedElement.addEventListener('touchmove', eventToLocationHandler(locationFunction, this.handleMove));

        this.annotatedElement.addEventListener('mouseup', eventToLocationHandler(locationFunction, this.handleStop));
        this.annotatedElement.addEventListener(
            'touchcancel',
            eventToLocationHandler(locationFunction, this.handleStop)
        );
        this.annotatedElement.addEventListener('touchend', eventToLocationHandler(locationFunction, this.handleStop));
    }
